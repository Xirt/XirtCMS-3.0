...
<div id="createModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-create" action="backend/templates/template/create" method="post" data-toggle="validator">
...
<div id="modifyModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-modify" action="backend/templates/template/modify" method="post" data-toggle="validator">
