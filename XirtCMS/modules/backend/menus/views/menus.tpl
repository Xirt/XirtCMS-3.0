...
<thead>
	<tr>
		...
		<th data-column-id="commands" data-header-css-class="table-row-commands align-middle" data-css-class="table-row-commands text-right" data-visible-in-selection="false">&nbsp;</th>
	</tr>
</thead>
<tbody></tbody>
<tfoot>
...
<div id="createModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-create" action="backend/menus/menu/create" method="post" data-toggle="validator">
...
<div id="modifyModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-modify" action="backend/menus/menu/modify" method="post" data-toggle="validator">
