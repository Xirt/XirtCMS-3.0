...
<thead>
	<tr>
		...
		<th data-column-id="target_url" data-header-css-class="table-row-target_url align-middle text-center" data-css-class="table-row-target_url align-middle text-center" data-visible-in-selection="true">Internal URI</th>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<label for="create_public_url" class="col-sm-4 col-form-label col-form-label-sm">URI</label>
						<div class="col-sm-8">
							<input type="text" class="form-control form-control-sm" id="create_public_url" name="route_public_url" placeholder="" required />
						</div>
					...
					<div class="form-group row">
						...
						<label for="create_target_url" class="col-sm-4 col-form-label col-form-label-sm">Target URI (internal)</label>
						<div class="col-sm-8">
							<input type="text" class="form-control form-control-sm" id="create_target_url" name="route_target_url" placeholder="" required />
						</div>
					...
					<div class="form-group row">
						...
						<label for="create_module_config" class="col-sm-4 col-form-label col-form-label-sm">Module Type</label>
						<div class="col-sm-8">

							<select class="form-control form-control-sm custom-select" id="create_module_config" name="route_module_config" required>

								<?php foreach ($moduleTypes as $moduleId => $moduleName): ?>
					...
					<div class="form-group row">
						...
						<label for="create_master" class="col-sm-4 col-form-label col-form-label-sm">Master Route</label>
						<div class="col-sm-8">
							<input type="text" class="form-control form-control-sm" id="create_master" name="route_master" placeholder="" />
						</div>
		...
		<form id="form-modify" action="backend/route/modify" method="post" data-toggle="validator">
			...
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h5 class="modal-title">Modify Route</h5>
