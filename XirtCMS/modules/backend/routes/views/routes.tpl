...
<div id="createModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-create" action="backend/routes/route/create" method="post" data-toggle="validator">
...
<div id="modifyModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="modal-dialog configuration" role="document">
		...
		<form id="form-modify" action="backend/routes/route/modify" method="post" data-toggle="validator">
