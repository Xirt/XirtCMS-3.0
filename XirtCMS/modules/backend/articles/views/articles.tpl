...
<div id="createModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-create" action="backend/articles/article/create" method="post" data-toggle="validator">
...
<div id="modifyModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-dialog article" role="document">
		...
		<form id="form-modify" action="backend/articles/article/modify" method="post" data-toggle="validator">
...
<div id="categoriesModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-categories" action="backend/articles/article/modify_categories" method="post" data-toggle="validator">
...
<div id="configModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-config" action="backend/articles/article/modify_config" method="post" data-toggle="validator">
...
<div id="publishModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-permit" action="backend/articles/article/modify_publish" method="post" data-toggle="validator">
