...
<div id="createModal" class="modal fade" tabindex="-1" role="dialog">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-create" action="backend/categories/category/create" method="post" data-toggle="validator">
...
<div id="modifyModal" class="modal fade" tabindex="-1" role="dialog">
	...
	<div class="modal-dialog" role="document">
		...
		<form id="form-modify" action="backend/categories/category/modify" method="post" data-toggle="validator">
