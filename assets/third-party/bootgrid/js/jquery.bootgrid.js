...
;(function ($, window, undefined)
{
	...
	// ** New method ** //
	function visibleByViewport(value) {
    ...
    */
                    ...
                    var refreshIcon = tpl.icon.resolve(getParams.call(this, { iconCss: css.iconRefresh })),
                        ...
                        { content: refreshIcon, text: this.options.labels.refresh })))
                            .on("click" + namespace, function (e)
                            {
								...
								// A.G. Gideonse (10/08/2016) - prevent reset of page counter
								that.reload()
    ...
    function renderSearchField()
    {
        ...
        if (this.options.navigation !== 0 && this.options.search !== false) /* Updated */
        {
            var css = this.options.css,
    ...
    Grid.defaults = {
		...
		defaultRowCount: 0, // default rowCount to pick in case of Array
        ...
        css: {
            ...
            left: "text-left",
            pagination: "pagination mx-auto", // must be a unique class name or constellation of class names within the header and footer
        ...
        templates: {
            ...
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row\"><div class=\"col-sm-6 d-flex text-center\"><p class=\"{{css.pagination}}\"></p></div><div class=\"col-sm-6 infoBar\"><p class=\"{{css.infos}}\"></p></div></div></div>",
    ...
    Grid.prototype.reload = function(reset)
    {
		...
		// A.G. Gideonse (10/08/2016) - Optionally reset
		this.current = reset ? 1 : this.current;

		// TODO: Prevent empty page on reload (e.g. last page call)
        loadData.call(this);
